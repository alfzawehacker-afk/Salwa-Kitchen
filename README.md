...
<body>
    ...
    <h3 style="color: var(--main-orange);">تواصل وتوصيل</h3>
    <div class="contact-grid">
        <a href="https://wa.me/01028857656"  target="_blank" class="contact-card">واتساب</a>
        <a href="https://web.facebook.com/" class="contact-card">فيسبوك</a>
        <a href="#" class="contact-card">اتصال هاتف</a>
        <a href="#" class="contact-card">الخط الأرضي</a>
    </div>
</section>
...
/* قسم التوصيل والتواصل البيضاوي */
.contact-section { padding: 40px 10px; text-align: center; }
.contact-grid { 
    display: flex; justify-content: center; 
    gap: 12px; flex-wrap: wrap; margin-top: 15px; 
}
.contact-card {
    background: var(--white); padding: 12px 25px;
    border-radius: 50px; text-decoration: none; color: var(--main-orange);
    font-weight: bold; border: 1px solid rgba(230, 126, 34, 0.2);
    font-size: 0.9rem; transition: 0.3s;
}
.contact-card:hover { background: var(--main-orange); color: white; }
